...
REPO="Gaonuk/hermes-whatsapp-kapso"
...
# --- Build download URLs ---
version="${TAG#v}"
asset="hermes-whatsapp-kapso_${version}_${os}_${arch}.tar.gz"
...
for bin in hermes-whatsapp-bridge hermes-whatsapp-cli; do
...
mkdir -p "$INSTALL_DIR"
install -m 0755 "$TMPDIR/hermes-whatsapp-bridge" "$INSTALL_DIR/hermes-whatsapp-bridge"
install -m 0755 "$TMPDIR/hermes-whatsapp-cli" "$INSTALL_DIR/hermes-whatsapp-cli"

echo "Installed:"
echo "  $INSTALL_DIR/hermes-whatsapp-bridge"
echo "  $INSTALL_DIR/hermes-whatsapp-cli"
...
echo
echo "Run 'hermes-whatsapp-cli preflight' to verify your setup."
